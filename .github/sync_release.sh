...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Gauntlet_MiSTer.git"
CORE_NAME=(Arcade-Gauntlet)
...
UPSTREAM_CORE_NAME=(Arcade-Gauntlet)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Gauntlet.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Gauntlet.rbf)
